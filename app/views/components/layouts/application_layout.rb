        ...
        Dropdown do |dropdown|
          ...
          dropdown.menu :base_100, class: "w-56 mt-2 shadow-lg" do |menu|
            ...
            if current_user&.admin?
              ...
              menu.item do
                a(href: admin_csrs_path, class: "flex items-center gap-2") do
                  render_icon("M10 6H5a2 2 0 00-2 2v9a2 2 0 002 2h14a2 2 0 002-2V8a2 2 0 00-2-2h-5m-4 0V5a2 2 0 114 0v1m-4 0a2 2 0 104 0m-5 8a2 2 0 100-4 2 2 0 000 4zm0 0c1.306 0 2.417.835 2.83 2M15 11h3m-3 4h2")
                  plain "CSRs"
                end
              end
              menu.item do
                a(href: admin_tools_path, class: "flex items-center gap-2") do
                  render_icon("M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.066 2.573c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.573 1.066c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.066-2.573c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z")
                  plain "Manage Tools"
                end
              end
              menu.item do
                a(href: admin_tags_path, class: "flex items-center gap-2") do
                  render_icon("M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z")
                  plain "Tags"
                end
              end
              menu.item do
